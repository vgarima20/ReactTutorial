...
render(){
    return(
        <React.Fragment>
            ...
            <input type="text" ref={this.ref3}></input> <br></br>
            <button onClick={()=>{this.props.fun_one(this.ref1.current?.value)}}>Button1</button> <br></br>
            <button onClick={()=>{this.props.fun_two(this.ref2.current?.value)}}>Button2</button><br></br>
            <button onClick={()=>{this.props.fun_three(this.ref3.current?.value)}}>Button3</button><br></br>
        </React.Fragment>
    )
}
};
